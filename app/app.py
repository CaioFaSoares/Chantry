...
app_online = True # We are currently running it!

# Status Cards Layout (Unified grid of 3 columns)
col1, col2, col3 = st.columns(3)

with col1:
    badge_html = "<span class='badge badge-online'>Online</span>" if app_online else "<span class='badge badge-offline'>Offline</span>"
    st.markdown(f"""
    <div class='card'>
        <div class='card-title'>💻 App Dashboard {badge_html}</div>
        <div class='card-desc'>
        ...
        <p style='color:#64748B; font-size:0.85rem; margin-bottom: 20px;'>Porta Host: <b>12501</b> | Caminho: <code>./app/app.py</code></p>
...
with col2:
    ...
    st.markdown(f"""
    <div class='card'>
        <div class='card-title'>🗄️ PocketBase Server {badge_html}</div>
        <div class='card-desc'>
...
with col3:
    ...
    st.markdown(f"""
    <div class='card'>
        <div class='card-title'>🐹 Go Server Daemon {badge_html}</div>
        <div class='card-desc'>
